                ...
                with torch.no_grad():
                    ...
                    for i in range(max_gen_len):
                        ...
                        if i == 0:
                            ...
                            #Naive loading
                            chunk_past_key_values = [list(kv) for kv in chunk_past_key_values]
                            for j in range(num_layer):
                                chunk_past_key_values[j][0] = fetch_kv_layer("key", j)
                                chunk_past_key_values[j][1] = fetch_kv_layer("value", j)
